...
const JIMA_INTENT_PATTERNS = Object.freeze({
  ...
  fileRead: /\b(read|summari[sz]e|analy[sz]e|explain)\b.*\b(file|pdf|docx|txt|lecture|resource|slides?)\b|\bwhat\s+(?:is|are|s)\b.*\b(about|lecture|file|resource)\b|can you read it|read it|what is.*about|תקרא|תקראי|תסכם|תסכמי|סכם.*קובץ|סכמי.*קובץ|נתח.*קובץ|נתחי.*קובץ|על מה.*הרצאה|מה.*הרצאה/,
